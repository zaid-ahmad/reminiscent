        ...
        <div className='w-full sm:w-[80rem] max-w-7xl rounded border border-zinc-200 shadow-md dark:border-gray-800 dark:bg-zinc-900'>
            <div className='w-full sm:w-[80rem] max-w-7xl h-[480px] p-4 overflow-y-auto'>
                <div className='flex items-start gap-2 animate-slide-up'>
                    <div className='rounded-xl bg-zinc-100 p-4 text-sm break-words max-w-[65%] sm:max-w-[55%] dark:bg-zinc-800 dark:text-zinc-100'>
                    ...
                    newChats.map((msg, index) => {
                        if (msg.role === "CHATBOT") {
                            return (
                                ...
                                >
                                    <div className=' rounded-xl bg-zinc-100 p-4 mt-2 text-sm break-words max-w-[65%] sm:max-w-[55%] dark:bg-zinc-800 dark:text-zinc-100'>
                                        {msg.message}
                                    </div>
                                </div>
                            );
                        ...
                        return (
                            ...
                            >
                                <div className='rounded-xl bg-red-500 p-4 mt-2 text-sm break-words max-w-[55%] text-white dark:bg-red-700 dark:text-zinc-100'>
                                    {msg.message}
                                </div>
                            </div>
                        );
